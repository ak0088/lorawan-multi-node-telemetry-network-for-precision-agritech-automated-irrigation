# LoRaWAN Multi-Node Telemetry Network for Precision Agritech & Automated Irrigation — Executive Short Notes & Viva Revision
...
- **Academic Domain**: Internet of Things (IoT) & Embedded
